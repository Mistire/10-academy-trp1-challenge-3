...
# Project Chimera Context & Prime Directives
...
Every major architectural decision or handshake success must be logged using the Project's MCP Sense mechanisms.

## 4. Development Standards
- Use `PYTHONPATH=.` for execution.
- Maintain strict typing in Python (Pydantic/MyPy).
- Adhere to the defined JSON schemas in `specs/technical.md`.
